...
#define kAppStoreAddress @"https://itunes.apple.com/us/app/tsamym/id907221754?l=ar&ls=1&mt=8"
#define kAppName @"تصاميم"
...
+(void)showRateAlertAfterTimesOpened:(int)times {
    ...
    NSUInteger timesOpened = [defaults integerForKey:@"timesOpened"];
